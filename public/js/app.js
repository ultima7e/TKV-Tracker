(() => {
  ...
  const TUNNEL_AREAS = [
    ...
    { id: 'headrace', label: 'Headrace', image: 'tunnel-headrace.jpg', dataDate: '03 Jul 2026', sections: [
      { name: 'Adit #4', design: '407.34 m', excavated: '390.00 m', pct: 95.74, x: 69.0, y: 60.8 },
      { name: 'Access to Valve Chamber', design: '183.21 m', excavated: '84.90 m', pct: 46.34, x: 52.4, y: 46.5 },
      ...
      { name: 'Lower Bend Shaft', design: '28.72 m', excavated: '7.20 m', pct: 25.07, x: 21.9, y: 65.8 },
      { name: 'Upper Bend Shaft', design: '28.72 m', pct: null, x: 28.8, y: 36.5 },
      { name: 'Headrace Tunnel (F1~F7)', design: '8,110.28 m', excavated: '564.66 m', pct: 6.96, x: 61.5, y: 22.3 },
    ] },
    { id: 'powerhouse', label: 'Powerhouse', image: 'tunnel-powerhouse.jpg', dataDate: '03 Jul 2026', sections: [
      ...
      { name: 'Tailrace Tunnel', design: '602.50 m', excavated: '18.10 m', pct: 3.22, x: 17.6, y: 54.8 },
    ] },
  ];
  const t3dColor = (p) =>
